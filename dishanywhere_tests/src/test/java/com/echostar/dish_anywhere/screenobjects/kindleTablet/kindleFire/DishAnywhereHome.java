...
public class DishAnywhereHome extends DishAnywhereMain {
    ...
    public EggplantElement settingsButton = new EggplantElement("settingsButton", By.Image("KindleTablet/KindleFireHDX/Apps/DishAnywhere/AppNav/SettingsOption", SearchRectangle.Quadrants.BOTTOM_QUARTER, ImageOption.waitFor(100)));
    ...
    public DishAnywhereLogin logOutIfLoggedIn() {
        ...
        if (loggedIn()) {
            Logger.info("User is logged in.  Logging out...");
    ...
    private boolean loggedIn() {
        Logger.info("Checking if iser is logged in...");
