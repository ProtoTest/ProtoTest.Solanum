...
public class DishAnywhereScrollView extends DishAnywhereMain {
    ...
    EggplantElement filterDropdownArrow = new EggplantElement("filterDropdownArrow", By.Image("iosTablet/iPadAir/Apps/DishAnywhere/OnDemand/OnDemandPage/CloseArrowIcon"));
    EggplantElement sortFilterButton = new EggplantElement("sortFilterButton", By.Image("iosTablet/iPadAir/Apps/DishAnywhere/OnDemand/OnDemandPage/SortFilterButton"));
