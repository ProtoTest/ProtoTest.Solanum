...
public class KindleSettings extends DeviceMain {
    ...
    EggplantElement middleOfScreen = new EggplantElement("middleOfScreen", By.Point(new Point(EggplantTestBase.getDriver().getScreenSize().x / 2, EggplantTestBase.getDriver().getScreenSize().y / 2)));
